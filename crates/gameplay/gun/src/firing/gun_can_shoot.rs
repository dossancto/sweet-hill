use crate::configuration::gun_components::{GunAmmo, GunFireSemiAuto};

pub(crate) fn has_enough_ammo(ammo: &GunAmmo) -> bool {
    ammo.current_ammo > 0
}

pub(crate) fn semi_auto_can_shoot(ammo: &GunAmmo, semi_auto: &GunFireSemiAuto, elapse_secs: f32) -> bool {
