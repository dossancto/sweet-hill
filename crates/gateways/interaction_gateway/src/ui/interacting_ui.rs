...
use interaction::interaction::components::{Interactable, Interacting};
...
pub(super) fn plugin(app: &mut App) {
    ...
    app.add_observer(hide_interacting_ui_text);
...
fn load_interacting_items(
    ...
    interactables_q: Single<(&Interactable, &Interacting), Without<InteractionLocked>>,
